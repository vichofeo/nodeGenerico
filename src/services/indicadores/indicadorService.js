...
const getDataModelN = async (dto, handleError) => {
    try {
        ...
        console.log(error)
        console.log("\n\nerror::: EN SERVICES\n", error.message)
        handleError.setMessage("Error de sistema: INDNSRV")
...
const getDataModelNew = async (dto, handleError) => {
    try {
        ...
        console.log(error);
        handleError.setMessage("Error de sistema: INDNEWSRV")
        handleError.setHttpError(error.message)
    };
...
const saveModel = async (dto, handleError)=>{
    try {
      ...
      console.log(error)
        handleError.setMessage("Error de sistema: INDOBJSAVEMODELCNF")
        handleError.setHttpError(error.message)
...
const getDataCboxLigado = async (dto, handleError) => {
    try {
        ...
        console.log(error);
        handleError.setMessage("Error de sistema: INDCBOXSRV")
        handleError.setHttpError(error.message)
    };
