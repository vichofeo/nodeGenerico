...
const PARAMETROS = {
    eess: {
        ...
        referer: [
            ...
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'accesibilidad_eess', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: '06ACCESIBILIDAD' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'carretera_eess', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: '06CARRETERA' },
        ],
    },
    institucion: {
        table: 'ae_institucion',
        alias: 'Identificacion',
        cardinalidad: "1",
        dual: ['ae_institucion','r_institucion_salud'],
        campos: {
        ...
        update: [],
        referer: [
            { ref: 'ae_institucion', camporef: 'institucion_id', camporefForeign: 'ente_gestor', campoLink:'ente_gestor_id' ,campos: ['nombre_institucion'], alias: null, condicion: null },
            
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'urbano_rural', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'AREA' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'subsector', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'SUBSECTOR' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'nivel_atencion', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'NIVELATENCION' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'clase', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'CLASE' },
    ...
    responsable: {
        ...
        alias: 'Responsable',
        dual: ['r_institucion_salud_responsable','au_persona'],
        cardinalidad: "1",
        campos: {
        ...
        update: [],
        referer: [
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'tipo_dni', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'PERDNITIPO' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'genero', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'PERGENERO' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'nacionalidad', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'PERNACIONALIDAD' },

            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'profesion_ocupacion', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'PERGRUPOPROFESION' },
    ...
    servicios_basicos: {
        ...
        update: [],
        referer: [
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'cableado_red', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'CALIFICACION' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'internet', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'AFIRMACION' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'empresa_internet', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'INTERNETEMP' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'financiamiento_internet', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'FINANCIAMIENTO' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'tipo_internet', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'INTERNETTIPO' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'con_energia', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'AFIRMACION' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'energia_electrica', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'ENERGIA' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'tipo_energia', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'ENERGIATIPO' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'sistema_iluminacion', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'CALIFICACION' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'conexion_gas', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'CALIFICACION' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'agua', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'AGUA' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'tratamiento_agua', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'CALIFICACION' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'alcantarillado', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'AFIRMACION' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'del_excretas', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'DELEXCRETA' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'telefonia_fija', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'CALIFICACION' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'telefonia_movil', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'CALIFICACION' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'central_oxigeno', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'CALIFICACION' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'gas_medicinal', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'CALIFICACION' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'filtro_aire', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'CALIFICACION' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'climatizacion', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'CALIFICACION' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'taller_mantenimiento', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'CALIFICACION' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'taller_reparacion', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'CALIFICACION' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'deposito_combustible', campos: ['atributo_id', 'atributo'], alias: 'grupo_atributo', condicion: 'CALIFICACION' },
        ],
    },
    ...
    atencion: {
        ...
        update: [],
        referer: [
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'atencion_horario', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'ATENCIONHORARIO' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'atencion_horas', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'ATENCIONHORAS' }
        ],
    },
//adecuado a R3
    superficie: {
        ...
        update: [],
        referer: [
            {ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'ccaracteristicas_terreno', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'TERRENO'},
            {ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'cascensor', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'AFIRMACION'},
            {ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'crampas', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'AFIRMACION'},
            {ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'cplano_aprobado', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'AFIRMACION'},
            {ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'cplan_mantenimiento', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'AFIRMACION'},
            {ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'cescalera_emergencia', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'AFIRMACION'},
            {ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'cparqueo', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'AFIRMACION'}
        ],
    },
    ...
    estructura: {
        ...
        update: [],
        referer: [
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'estructura_estado', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'ESTRUCTURAESTADO' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'estructura_base', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'ESTRUCTURABASE' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'estructura_techo', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'ESTRUCTURATECHO' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'estructura_piso', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'ESTRUCTURAPISO' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'estructura_acabado_exterior', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'ESTRUCTURAACABADO' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'estructura_acabado_interior', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'ESTRUCTURAACABADO' },
        ],
    },
    ...
    infraestructura: {
        ...
        update: [],
        referer: [
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'servicio', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'SERVICIOMEDICO' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'descripcion', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'SERVICIODESCMEDICO' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'estado', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'ESTRUCTURAESTADO' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'funcionamiento', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'FUNCIONA' },
        ],
    },
    mobiliarion: {
    ...
    mobiliario:{
        ...
        referer: [
            ...
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'estado', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'ESTRUCTURAESTADO' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'funcionamiento', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'FUNCIONA' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'fuente_financiamiento', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'FINANCIAMIENTOFUENTE' },
        ],
    },
    ...
    personal_is: {
        ...
        alias: 'Personal',
        dual: ['r_institucion_salud_personal','au_persona'],
        cardinalidad: "1",
        campos: {
        ...
        update: [],
        referer: [
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'item_contrato', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'PERITEMCONTRATO' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'item_contrato_desc', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'PERITEMCONTRATODESC' },
            //au
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'tipo_dni', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'PERDNITIPO' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'estado_civil', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'PERESTADOCIVIL' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'genero', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'PERGENERO' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'nacionalidad', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'PERNACIONALIDAD' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'nivel_instruccion', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'PERNIVELINSTRUCCION' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'discapacidad', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'AFIRMACION' },
//isp       
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'profesion_ocupacion', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'PERGRUPOPROFESION' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'profesion_ocupacion_especifica', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'PERGRUPOPROFESPECIFICA', linked:{campos:[['atributo_id','value']],ref:'r_is_atributo', alias:'grplinkn', dependency:'profesion_ocupacion' }},

            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'fuente_financiamiento', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'FINANCIAMIENTOFUENTE' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'descripcion_cargo', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'PERGRUPOPROFESION' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'carga_laboral', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'PERCARGAHORARIA' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'personal_rotatorio', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'AFIRMACION' },
    ...
    eess_corto: {
        ...
        referer: [
            ...
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'subsector', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'SUBSECTOR' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'urbano_rural', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'AREA' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'snis', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'ACTIVE' },
    ...
    acreditacion:{
        ...
        update: [],
        referer: [
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'estado_acrehab', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'AHACREDITACION' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'activo', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'ACTIVE' },
        ],
    },
    acreditacionn:{
    ...
    habilitacion:{
        ...
        update: [],
        referer: [
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'estado_acrehab', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'AHHABILITACION' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'activo', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'ACTIVE' },
        ],
    },
    habilitacionn:{
    ...
    r3estuctura: {
        ...
        update: [],
        referer: [
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'estructura', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'R3ESTRUCTURA' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'material', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'R3ESTRUCTURAMATERIAL', linked:{campos:[['atributo_id','value']],ref:'r_is_atributo', alias:'grplinkn', dependency:'estructura' }},
    ...
    r3areas: {
        ...
        cardinalidad: "1",
        campos: {                
            area: ['Area', true, true, 'C'],
            ambiente: ['Ambiente', true, true, 'C'],
            estado: ['Estado', true, true, 'C'],
        ...
        update: [],
        referer: [
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'area', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'R3AREA' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'ambiente', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'R3AREAAMBIENTE', linked:{campos:[['atributo_id','value']],ref:'r_is_atributo', alias:'grplinkn', dependency:'area' }},
    ...
    r3mobiliario:{
        ...
        key: ['registro_id'],
        update: [],
        ilogic:{area_id:"SELECT area_id AS value, ar.atributo||'/'||am.atributo as text FROM r_institucion_salud_areas a, r_is_atributo ar, r_is_atributo am WHERE a.area=ar.atributo_id AND a.ambiente=am.atributo_id  ORDER BY 1"},
        referer: [
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'tipo', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'R3MOBITIPO' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'descripcion', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'REMOBITIPODESC', linked:{campos:[['atributo_id','value']],ref:'r_is_atributo', alias:'grplinkn', dependency:'tipo' } },
            //{ ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'estado', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'ESTRUCTURAESTADO' },
            //{ ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'financiamiento', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'FINANCIAMIENTOFUENTE' },
            //{ ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'funcionamiento', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'FUNCIONA' },
            //{ ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'en_mantenimiento', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'AFIRMACION' },
            //{ ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'en_uso', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'AFIRMACION' },
        ],
    },
    ...
    r3equipamiento:{
        ...
        referer: [        
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'tipo', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'R3EQUITIPO' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'descripcion', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'R3EQUITIPODESC', linked:{campos:[['atributo_id','value']],ref:'r_is_atributo', alias:'grplinkn', dependency:'tipo' } },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'estado', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'ESTRUCTURAESTADO' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'financiamiento', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'FINANCIAMIENTOFUENTE' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'funcionamiento', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'FUNCIONA' },
            { ref: 'r_is_atributo', camporef: 'atributo_id', camporefForeign: 'en_mantenimiento', alias: 'grupo_atributo', campos: ['atributo_id', 'atributo'], condicion: 'AFIRMACION' },
